...
+function(a) {
   ...
   * ------------------------------------------------------------------------
   */
        a.fn[b] = j._jQueryInterface, a.fn[b].Constructor = j, a.fn[b].noConflict = function() {
            ...
            return b.prototype.toggle = function() {
                ...
                if (c) {
                    ...
                    if (d) {
                        ...
                        b && (d.checked = !a(this._element).hasClass(f.ACTIVE), a(d).trigger("change")), 
                        d.focus();
                    }
                }
                this._element.setAttribute("aria-pressed", !a(this._element).hasClass(f.ACTIVE)), 
                b && a(this._element).toggleClass(f.ACTIVE);
            }, b.prototype.dispose = function() {
   ...
   * ------------------------------------------------------------------------
   */
        var b = "carousel", g = "bs.carousel", h = "." + g, i = a.fn[b], j = {
            interval: 5e3,
            keyboard: !0,
            slide: !1,
            pause: "hover",
            ...
            function i(b, d) {
                ...
                this._indicatorsElement = a(this._element).find(o.INDICATORS)[0], this._addEventListeners();
            }
            // getters
            // public
            // private
            ...
            return i.prototype.next = function() {
                ...
                b || (this._isPaused = !0), a(this._element).find(o.NEXT_PREV)[0] && f.supportsTransitionEnd() && (f.triggerTransitionEnd(this._element), 
                ...
                var d = this, e = a(this._element).find(o.ACTIVE_ITEM)[0], g = c || e && this._getItemByDirection(b, e), h = Boolean(this._interval), i = void 0, j = void 0, k = void 0;
                if (b === l.NEXT ? (i = n.LEFT, j = n.NEXT, k = l.LEFT) : (i = n.RIGHT, j = n.PREV, 
                k = l.RIGHT), g && a(g).hasClass(n.ACTIVE)) return void (this._isSliding = !1);
                if (!this._triggerSlideEvent(g, k).isDefaultPrevented() && e && g) {
                    ...
                    f.supportsTransitionEnd() && a(this._element).hasClass(n.SLIDE) ? (a(g).addClass(j), 
                    f.reflow(g), a(e).addClass(i), a(g).addClass(i), a(e).one(f.TRANSITION_END, function() {
                        a(g).removeClass(i + " " + j).addClass(n.ACTIVE), a(e).removeClass(n.ACTIVE + " " + j + " " + i), 
                        d._isSliding = !1, setTimeout(function() {
                            return a(d._element).trigger(p);
                        }, 0);
                    }).emulateTransitionEnd(600)) : (a(e).removeClass(n.ACTIVE), a(g).addClass(n.ACTIVE), 
                    this._isSliding = !1, a(this._element).trigger(p)), h && this.cycle();
                }
   ...
   * ------------------------------------------------------------------------
   */
        var b = "collapse", g = "bs.collapse", h = a.fn[b], i = {
            toggle: !0,
            parent: ""
        }, j = {
            toggle: "boolean",
            ...
            return h.prototype.toggle = function() {
                ...
                if (!a(this._element).hasClass(l.SHOW)) {
                    ...
                    if (this._parent && (c = a.makeArray(a(this._parent).find(n.ACTIVES)), c.length || (c = null)), 
                    !(c && (d = a(c).data(g)) && d._isTransitioning)) {
                        ...
                        if (a(this._element).trigger(e), !e.isDefaultPrevented()) {
                            ...
                            var j = function() {
                                a(b._element).removeClass(l.COLLAPSING).addClass(l.COLLAPSE).addClass(l.SHOW), b._element.style[i] = "", 
                ...
                if (a(this._element).hasClass(l.SHOW)) {
                    ...
                    if (a(this._element).trigger(c), !c.isDefaultPrevented()) {
                        ...
                        this._element.style[d] = this._element[e] + "px", f.reflow(this._element), a(this._element).addClass(l.COLLAPSING).removeClass(l.COLLAPSE).removeClass(l.SHOW), 
                ...
                return c = a.extend({}, i, c), c.toggle = Boolean(c.toggle), f.typeCheckConfig(b, c, j), 
                c;
                ...
                return this.each(function() {
                    var c = a(this), e = c.data(g), f = a.extend({}, i, c.data(), "object" === (void 0 === b ? "undefined" : d(b)) && b);
                    if (!e && f.toggle && /show|hide/.test(b) && (f.toggle = !1), e || (e = new h(this, f), 
                    c.data(g, e)), "string" == typeof b) {
   ...
   */
        var b = "dropdown", d = ".bs.dropdown", g = a.fn[b], h = {
            ...
            return b.prototype.toggle = function() {
                ...
                return a(c).trigger(g), !g.isDefaultPrevented() && (this.focus(), this.setAttribute("aria-expanded", !0), 
                a(c).toggleClass(i.SHOW), a(c).trigger(a.Event(h.SHOWN, f)), !1);
            }, b.prototype.dispose = function() {
                ...
                if (!c || 3 !== c.which) {
                    ...
                    for (var e = a.makeArray(a(j.DATA_TOGGLE)), f = 0; f < e.length; f++) {
                        var g = b._getParentFromElement(e[f]), k = {
                            relatedTarget: e[f]
                        };
                        if (a(g).hasClass(i.SHOW) && !(c && ("click" === c.type && /input|textarea/i.test(c.target.tagName) || "focusin" === c.type) && a.contains(g, c.target))) {
                            ...
                            a(g).trigger(l), l.isDefaultPrevented() || (e[f].setAttribute("aria-expanded", "false"), 
                            a(g).removeClass(i.SHOW).trigger(a.Event(h.HIDDEN, k)));
                        }
                    }
                }
                ...
                c.stopPropagation(), !this.disabled && !a(this).hasClass(i.DISABLED))) {
                    ...
                    if (g.length) {
                        ...
                        38 === c.which && h > 0 && // up
                        h--, 40 === c.which && h < g.length - 1 && // down
                        h++, h < 0 && (h = 0), g[h].focus();
                    }
                }
            }, e(b, null, [ {
   ...
   * ------------------------------------------------------------------------
   */
        var b = "modal", g = ".bs.modal", h = a.fn[b], i = {
            backdrop: !0,
            keyboard: !0,
            focus: !0,
            show: !0
            ...
            function h(b, d) {
                c(this, h), this._config = this._getConfig(d), this._element = b, this._dialog = a(b).find(m.DIALOG)[0], 
            ...
            return h.prototype.toggle = function(a) {
                ...
                this._checkScrollbar(), this._setScrollbar(), a(document.body).addClass(l.OPEN), 
                this._setEscapeEvent(), this._setResizeEvent(), a(this._element).on(k.CLICK_DISMISS, m.DATA_DISMISS, function(a) {
                    return c.hide(a);
                ...
                a(this._element).trigger(e), this._isShown && !e.isDefaultPrevented() && (this._isShown = !1, 
                this._setEscapeEvent(), this._setResizeEvent(), a(document).off(k.FOCUSIN), a(this._element).removeClass(l.SHOW), 
                a(this._element).off(k.CLICK_DISMISS), a(this._dialog).off(k.MOUSEDOWN_DISMISS), 
                d ? a(this._element).one(f.TRANSITION_END, function(a) {
                    return c._hideModal(a);
                }).emulateTransitionEnd(300) : this._hideModal());
            }, h.prototype.dispose = function() {
                a.removeData(this._element, "bs.modal"), a(window, document, this._element, this._backdrop).off(g), 
                ...
                this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE || // don't move modals dom position
                document.body.appendChild(this._element), this._element.style.display = "block", 
                this._element.removeAttribute("aria-hidden"), this._element.scrollTop = 0, d && f.reflow(this._element), 
                a(this._element).addClass(l.SHOW), this._config.focus && this._enforceFocus();
                ...
                this._isTransitioning = !1, this._showBackdrop(function() {
                    a(document.body).removeClass(l.OPEN), b._resetAdjustments(), b._resetScrollbar(), 
                    a(b._element).trigger(k.HIDDEN);
                });
                ...
                if (this._isShown && this._config.backdrop) {
                    ...
                    if (this._backdrop = document.createElement("div"), this._backdrop.className = l.BACKDROP, 
                    d && a(this._backdrop).addClass(d), a(this._backdrop).appendTo(document.body), a(this._element).on(k.CLICK_DISMISS, function(a) {
                ...
                return this.each(function() {
                    var e = a(this).data("bs.modal"), f = a.extend({}, h.Default, a(this).data(), "object" === (void 0 === b ? "undefined" : d(b)) && b);
   ...
   */
        var b = "scrollspy", g = a.fn[b], h = {
            ...
            function g(b, d) {
                var e = this;
                c(this, g), this._element = b, this._scrollElement = "BODY" === b.tagName ? window : b, 
                this._config = this._getConfig(d), this._selector = this._config.target + " " + l.NAV_LINKS + "," + this._config.target + " " + l.DROPDOWN_ITEMS, 
            ...
            return g.prototype.refresh = function() {
                var b = this, c = this._scrollElement !== this._scrollElement.window ? m.POSITION : m.OFFSET, d = "auto" === this._config.method ? c : this._config.method, e = d === m.POSITION ? this._getScrollTop() : 0;
                ...
                a.removeData(this._element, "bs.scrollspy"), a(this._scrollElement).off(".bs.scrollspy"), 
                ...
                d.addClass(k.ACTIVE)) : // todo (fat) this is kinda sus...
                // recursively add actives to tested nav-links
                d.parents(l.LI).find("> " + l.NAV_LINKS).addClass(k.ACTIVE), a(this._scrollElement).trigger(j.ACTIVATE, {
                    relatedTarget: b
                });
        ...
        var b = a.fn.tab, d = {
            ...
            return b.prototype.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && a(this._element).hasClass(g.ACTIVE) || a(this._element).hasClass(g.DISABLED))) {
                    var c = void 0, e = void 0, i = a(this._element).closest(h.LIST)[0], j = f.getSelectorFromElement(this._element);
                ...
                var e = this, i = a(c).find(h.ACTIVE_CHILD)[0], j = d && f.supportsTransitionEnd() && (i && a(i).hasClass(g.FADE) || Boolean(a(c).find(h.FADE_CHILD)[0])), k = function() {
                ...
                if (a(b).addClass(g.ACTIVE), b.setAttribute("aria-expanded", !0), d ? (f.reflow(b), 
                a(b).addClass(g.SHOW)) : a(b).removeClass(g.FADE), b.parentNode && a(b.parentNode).hasClass(g.DROPDOWN_MENU)) {
   ...
   */
        var b = "tooltip", g = ".bs.tooltip", h = a.fn[b], i = {
            ...
            function h(a, b) {
                ...
                this._isTransitioning = !1, this._tether = null, // protected
            ...
            return h.prototype.enable = function() {
                ...
                if (this.isWithContent() && this._isEnabled) {
                    ...
                    this.config.animation && a(e).addClass(n.FADE);
                    var i = "function" == typeof this.config.placement ? this.config.placement.call(this, e, this.element) : this.config.placement, j = this._getAttachment(i), k = !1 === this.config.container ? document.body : a(this.config.container);
                    a(e).data(this.constructor.DATA_KEY, this).appendTo(k), a(this.element).trigger(this.constructor.Event.INSERTED), 
                    ...
                    var m = function() {
                        var c = b._hoverState;
                        b._hoverState = null, b._isTransitioning = !1, a(b.element).trigger(b.constructor.Event.SHOWN), 
                        c === l.OUT && b._leave(null, b);
                    };
                    if (f.supportsTransitionEnd() && a(this.tip).hasClass(n.FADE)) return this._isTransitioning = !0, 
                    void a(this.tip).one(f.TRANSITION_END, m).emulateTransitionEnd(h._TRANSITION_DURATION);
                    m();
                }
            }, h.prototype.hide = function(b) {
                ...
                if (this._isTransitioning) throw new Error("Tooltip is transitioning");
                var g = function() {
                    c._hoverState !== l.SHOW && d.parentNode && d.parentNode.removeChild(d), c.element.removeAttribute("aria-describedby"), 
                    a(c.element).trigger(c.constructor.Event.HIDDEN), c._isTransitioning = !1, c.cleanupTether(), 
                    b && b();
                };
                a(this.element).trigger(e), e.isDefaultPrevented() || (a(d).removeClass(n.SHOW), 
                this._activeTrigger[q.CLICK] = !1, this._activeTrigger[q.FOCUS] = !1, this._activeTrigger[q.HOVER] = !1, 
                f.supportsTransitionEnd() && a(this.tip).hasClass(n.FADE) ? (this._isTransitioning = !0, 
                a(d).one(f.TRANSITION_END, g).emulateTransitionEnd(150)) : g(), this._hoverState = "");
                ...
                this.setElementContent(b.find(o.TOOLTIP_INNER), this.getTitle()), b.removeClass(n.FADE + " " + n.SHOW), 
                this.cleanupTether();
            }, h.prototype.setElementContent = function(b, c) {
                var e = this.config.html;
                "object" === (void 0 === c ? "undefined" : d(c)) && (c.nodeType || c.jquery) ? // content is a DOM node or a jQuery
                e ? a(c).parent().is(b) || b.empty().append(c) : b.text(a(c).text()) : b[e ? "html" : "text"](c);
                ...
                this.config.trigger.split(" ").forEach(function(c) {
                    if ("click" === c) a(b.element).on(b.constructor.Event.CLICK, b.config.selector, function(a) {
                        ...
                        var d = c === q.HOVER ? b.constructor.Event.MOUSEENTER : b.constructor.Event.FOCUSIN, e = c === q.HOVER ? b.constructor.Event.MOUSELEAVE : b.constructor.Event.FOCUSOUT;
                ...
                a(b.currentTarget).data(d, c)), b && (c._activeTrigger["focusin" === b.type ? q.FOCUS : q.HOVER] = !0), 
                a(c.getTipElement()).hasClass(n.SHOW) || c._hoverState === l.SHOW ? void (c._hoverState = l.SHOW) : (clearTimeout(c._timeout), 
                c._hoverState = l.SHOW, c.config.delay && c.config.delay.show ? void (c._timeout = setTimeout(function() {
                    c._hoverState === l.SHOW && c.show();
                }, c.config.delay.show)) : void c.show());
            }, h.prototype._leave = function(b, c) {
                var d = this.constructor.DATA_KEY;
                if (c = c || a(b.currentTarget).data(d), c || (c = new this.constructor(b.currentTarget, this._getDelegateConfig()), 
                a(b.currentTarget).data(d, c)), b && (c._activeTrigger["focusout" === b.type ? q.FOCUS : q.HOVER] = !1), 
                ...
                return this.each(function() {
                    ...
                    if ((c || !/dispose|hide/.test(b)) && (c || (c = new h(this, e), a(this).data("bs.tooltip", c)), 
                    "string" == typeof b)) {
                        if (void 0 === c[b]) throw new Error('No method named "' + b + '"');
                        c[b]();
                    }
   ...
   */
        var h = "popover", i = ".bs.popover", j = f.fn[h], k = f.extend({}, g.Default, {
            ...
            return b(j, g), j.prototype.isWithContent = function() {
                ...
                this.setElementContent(a.find(n.TITLE), this.getTitle()), this.setElementContent(a.find(n.CONTENT), this._getContent()), 
                a.removeClass(m.FADE + " " + m.SHOW), this.cleanupTether();
                ...
                return this.each(function() {
                    ...
                    if ((b || !/destroy|hide/.test(a)) && (b || (b = new j(this, c), f(this).data("bs.popover", b)), 
                    "string" == typeof a)) {
